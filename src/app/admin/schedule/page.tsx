...
const HOLIDAYS_2027: Record<string, string> = {
  ...
  '2027-10-03': '개천절', '2027-10-09': '한글날', '2027-10-11': '대체공휴일', '2027-12-25': '크리스마스',
};
const ALL_HOLIDAYS: Record<string, string> = { ...HOLIDAYS_2026, ...HOLIDAYS_2027 };
